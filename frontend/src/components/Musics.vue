<template>
  <div class= "m-md-3">
    <div class="position-relative overflow-hidden p-5 p-md-0 m-md-0 text-center bg-body-tertiary">
      <div class="col-md-6 p-lg-5 mx-auto my-1 mb-2">
        <h1 class="display-4 fw-bold px-5">{{ titulo }}</h1>
        <h3 class="fw-normal text-muted mb-2">The most beautiful API in the world</h3>
      </div>
          ...
          <div class="container-fluid">
            <div
              ...
              <div class="d-flex justify-content-center mt-3">
                <button
                  class="btn btn-outline-success formataBotao"
                  type="submit">
                  Search by genre
                </button>
                <div class="px-2"></div>
...
export default {
  ...
  methods: {
    ...
    MusicList: (scope) => {
      axios.get(process.env.VUE_APP_ALL_MUSICS).then((resp) => {
        // console.log(resp)
        scope.musics = resp.data;
      });
    },

    ordenaMusicasAZ(event) {
      return {};
    },
  },
  created() {
